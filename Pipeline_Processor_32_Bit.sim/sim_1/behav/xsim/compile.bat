...
REM
REM Generated by Vivado on Wed Apr 22 20:17:09 -0700 2026
...
echo "xvlog --incr --relax -L uvm -prj Pipeline_Processor_32_Bit_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj Pipeline_Processor_32_Bit_tb_vlog.prj -log xvlog.log
